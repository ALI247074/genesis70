...
projectTypeSelect.addEventListener("change", () => {
  next1.disabled = projectTypeSelect.value === "";
});
...
next4.addEventListener("click", () => {
  ...
  displaySummary();
  showStep(4); // صفحة النتيجة النهائية
});
...
function displaySummary() {
  ...
  liCustom.textContent = "Final Customization: " + (selectedCustom.length ? selectedCustom.join(", ") : "None");
